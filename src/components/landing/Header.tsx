        ...
        >
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-2">
                    ...
                    <span className="text-xl font-bold text-white">Blog Platform</span>
                </Link>
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <Link href="/auth/signup">
                        <button className="px-6 py-2 bg-gradient-to-b from-blue-600 to-blue-800 text-white rounded-lg transition-all duration-300 border border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/20">
                            Get Started
                        </button>
                    </Link>
                </div>
                    ...
                    <div className="container mx-auto px-4 py-4 space-y-4">
                        ...
                        <div className="pt-4 space-y-2">
                            ...
                            <Link href="/auth/signup" className="block">
                                <button className="w-full px-6 py-2 bg-gradient-to-b from-blue-600 to-blue-800 text-white rounded-lg transition-all duration-300 border border-blue-500/50">
                                    Get Started
                                </button>
                            </Link>
                        </div>
