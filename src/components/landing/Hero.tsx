...
import { PenTool, Zap, Users, TrendingUp } from "lucide-react";
    ...
    return (
        <section className="relative pt-32 pb-16 container mx-auto px-4 z-10">
            ...
            >
                ...
                >
                    Craft Your Narrative <br className="hidden md:block" /> Build Your Audience
                </motion.h1>
                ...
                >
                    The modern publishing platform for thoughtful writers. Create beautiful stories, grow your newsletter, and analyze your reach with powerful, built-in tools designed for creators.
                </motion.p>
                ...
                >
                    <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-colors duration-300">
                        <PenTool className="w-8 h-8 text-blue-400 shrink-0" />
                        <div className="text-left">
                            <p className="text-white font-medium">Distraction Free</p>
                            <p className="text-white/60 text-sm">Focus on your writing</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-colors duration-300">
                        <Zap className="w-8 h-8 text-green-400 shrink-0" />
                        <div className="text-left">
                            <p className="text-white font-medium">Instant Publish</p>
                    ...
                    <div className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10 hover:bg-white/10 transition-colors duration-300">
                        ...
                        <div className="text-left">
                            <p className="text-white font-medium">Audience Insights</p>
                            <p className="text-white/60 text-sm">Deep analytics built-in</p>
                        </div>
                    </div>
                </motion.div>
                ...
                >
                    <Link href="/auth/signup">
                        <button className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 border border-blue-500/50">
                            Start Publishing
                        </button>
                    </Link>
                    <Link href="/dashboard">
